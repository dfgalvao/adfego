...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { body_of_matter: @notice.body_of_matter, publication: @notice.publication, subtitle: @notice.subtitle, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { body_of_matter: @notice.body_of_matter, publication: @notice.publication, subtitle: @notice.subtitle, title: @notice.title } }
